...
List<Therapy> therapies = [
  ...
  int userCount = 0;
  int familyCount = 0;
  User localUser = User(username: 'Hrcak', name: 'Biti', surname: 'Ne biti', age: 4, therapies: [Therapy('Sinersul', 500, 20, DateTime.now(), DateTime.now().add(const Duration(days: 1)), [const TimeOfDay(hour: 9, minute: 0)])]);
  User localUser2 = User(username: 'Hrcak2', name: 'Liti', surname: 'De1 biti', age: 5, therapies: [Therapy('Nes drugo', 500, 20, DateTime.now(), DateTime.now().add(const Duration(days: 1)), [const TimeOfDay(hour: 9, minute: 0)])]);
  User localUser3 = User(username: 'Hrcak3', name: 'Piti', surname: 'De2 biti', age: 6, therapies: [Therapy('Nes trece', 500, 20, DateTime.now(), DateTime.now().add(const Duration(days: 1)), [const TimeOfDay(hour: 9, minute: 0)])]);
